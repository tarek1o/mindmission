...
export class GetAllUsersPaginatedWithCountUseCase {
  ...
  execute(query: GetAllUsersQueryInput, order: IOrder<AllowedUserOrderColumnsEnum>, pagination: Pagination) {
    return this.userRepository.getAllPaginatedWithTotalCount(query, order, pagination);
  }
}