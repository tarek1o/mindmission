...
@Index('user_profile_changes_user_id_field_partial_unique_index', ['userId', 'field'], {
  unique: true,
...
export class UserProfileChangeEntity extends BaseEntity {
  ...
  @ManyToOne(() => UserEntity, user => user.profileChanges, { onUpdate: 'CASCADE', onDelete: 'CASCADE' })
