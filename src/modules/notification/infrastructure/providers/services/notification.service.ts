...
export class NotificationService implements INotificationService {
  constructor(
    @Inject(QUEUE_PUBLISHER_SERVICE) private readonly queuePublisherService: IQueuePublisherService,
    @Inject(NOTIFICATION_QUEUE_MAPPING) private readonly notificationQueueMapping: Map<NotificationMessage, string>,
  ) {} 
