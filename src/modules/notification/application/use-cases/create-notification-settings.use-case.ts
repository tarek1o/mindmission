...
export class CreateNotificationSettingsUseCase {
  ...
  private async create(input: NotificationSettingsInput): Promise<NotificationSettingsModel> {
  ...
  private async cacheCreatedNotificationSettings(notificationSettings: NotificationSettingsModel): Promise<void> {
  ...
  async execute(input: NotificationSettingsInput): Promise<NotificationSettingsModel> {
    await this.notificationSettingsValidatorService.validateNotificationEventNotDuplicate(input.notificationEvent);
