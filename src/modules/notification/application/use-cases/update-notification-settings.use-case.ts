...
export class UpdateNotificationSettingsUseCase {
  ...
  private async update(
    ...
    input: Partial<NotificationSettingsInput>,
  ...
  private async cacheUpdatedNotificationSettings(
    notificationSettings: NotificationSettingsModel,
  ): Promise<void> {
