...
export abstract class OAuthFlowStrategy {
  abstract handle(profile: ProviderProfileInput, user?: UserModel): Promise<UserModel>;

  protected constructOAuthProviderModel(providerProfile: ProviderProfileInput, userId: number): OAuthProfileModel {
