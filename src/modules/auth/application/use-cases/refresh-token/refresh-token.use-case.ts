...
export class RefreshTokenUseCase {
  ...
  private async rotateCurrentRefreshToken(
  ...
  async execute(
    ...
    const refreshTokenModel =
      await this.actionTokenVerifierService.verifyRefreshToken(refreshToken);
    ...
    const rotatedRefreshTokenModel = await this.rotateCurrentRefreshToken(
      refreshTokenModel,
      user,
    );
    return {
