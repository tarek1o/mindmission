...
export class PermissionFinderService {
  ...
  async getWithTranslationsById(id: number): Promise<PermissionWithTranslationsViewModel> {
    const permissionWithTranslationsViewModel = await this.permissionRepository.getWithTranslationsById(id);
