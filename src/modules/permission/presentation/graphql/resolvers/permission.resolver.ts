...
export class PermissionResolver {
  ...
  async getPermissionsByLanguage(
    ...
    const permissionTranslationModels =
      await this.getPermissionsByLanguageUseCase.execute(language);
    return permissionTranslationModels.map(
      (permissionTranslationViewModel) =>
        new PermissionListType(permissionTranslationViewModel),
    );
  }
  ...
  async createPermission(
    ...
    const permissionViewModel = await this.createPermissionUseCase.execute(
  ...
  async updatePermission(
    ...
    const permissionViewModel = await this.updatePermissionUseCase.execute(
      id,
