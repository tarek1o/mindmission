...
export class CategoryFinderService {
  ...
  async getWithTranslationsById(id: number): Promise<CategoryWithTranslationsViewModel> {
    const categoryWithTranslationsViewModel = await this.categoryRepository.getByIdWithTranslations(id);
